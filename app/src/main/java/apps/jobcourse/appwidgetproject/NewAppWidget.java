package apps.jobcourse.appwidgetproject;
...
public class NewAppWidget extends AppWidgetProvider {
    ...
    private static final String mShareFile = BuildConfig.APPLICATION_ID;
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        SharedPreferences pref = context.getSharedPreferences(mShareFile, 0);
